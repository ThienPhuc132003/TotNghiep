...
import Avatar_Phuc from "../../assets/images/Avatar_phuc.jpg"; // Đảm bảo đường dẫn ảnh đúng
import Avatar_Lam from "../../assets/images/Avatar_lam.png"; // Đảm bảo đường dẫn ảnh đúng
const AboutUsComponent = () => {
  ...
  const handleTutorSearchPage = () => {
    navigate("/tim-kiem-gia-su"); // Đường dẫn đến trang tìm kiếm gia sư
  };
      ...
      <div className="about-us-container">
        ...
        <section className="hero-section-new">
          <div className="hero-content-new">
            ...
            <p className="hero-subtitle-new">
              ...
              giúp bạn tự tin chinh phục mục tiêu học tập và phát triển bản
              thân.
            </p>
            ...
            <button
              className="hero-cta-button-new"
              onClick={handleTutorSearchPage}
            >
              Tìm Gia Sư Ngay
              <i
        ...
        <section className="story-section section-padding">
          ...
          <p className="section-subtitle">
            Xuất phát từ chính những trăn trở của sinh viên Văn Lang trong quá
            trình học tập, Gia Sư Văn Lang ra đời với sứ mệnh tạo cầu nối vững
            chắc giữa người cần học và người có thể dạy. Chúng tôi tin rằng, với
            sự hỗ trợ đúng đắn và phương pháp phù hợp, mọi sinh viên đều có thể
            vượt qua thử thách và đạt được thành công. Nền tảng của chúng tôi
            không chỉ cung cấp gia sư, mà còn là người bạn đồng hành, thấu hiểu
            và hỗ trợ bạn trên con đường học vấn tại VLU.
          </p>
        </section>
        ...
        <section className="why-choose-section section-padding">
          ...
          <ul className="why-choose-list">
            <li>
              ...
              <span>
                Đội ngũ gia sư thường là các sinh viên, thân thiện và đa dạng
                cho học viên lựa chọn
              </span>
            </li>
            <li>
              <i className="fas fa-check-circle why-choose-icon"></i>
              <span>
                Quy trình tuyển chọn và đánh giá gia sư nghiêm ngặt, đảm bảo
                chất lượng.
              </span>
            </li>
            <li>
              <i className="fas fa-check-circle why-choose-icon"></i>
              <span>
                Lộ trình học tập được cá nhân hóa, bám sát mục tiêu và tốc độ
                của từng sinh viên.
              </span>
            </li>
            <li>
              <i className="fas fa-check-circle why-choose-icon"></i>
              <span>
                Nền tảng tiện lợi, dễ dàng tìm kiếm, đặt lịch và quản lý buổi
                học.
              </span>
            </li>
            <li>
        ...
        <section className="team-section section-padding">
          ...
          <p className="section-subtitle">
            Những người đứng sau Gia Sư Văn Lang, luôn nỗ lực mang đến trải
            nghiệm tốt nhất.
          </p>
          ...
          <div className="contact-wrapper">
            <div className="contact-info">
              ...
              <p>
                ...
                Điện thoại: <a href="tel:02871099200">028 7109 9200</a>{" "}
                {/* Cân nhắc số riêng */}
              </p>
              <p>
