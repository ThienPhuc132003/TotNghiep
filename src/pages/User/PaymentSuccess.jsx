...
import { faCheckCircle, faSpinner, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons'; // Thêm icons
import './PaymentResult.style.css'; // CSS cho trang kết quả
                ...
                <div className="payment-result-container">
                    <div className="payment-result-content success">
                        ...
                        {!profileLoading && !profileError && (
                         ...
                         {profileLoading && (
                             <FontAwesomeIcon icon={faSpinner} spin className="status-icon icon-loading" />
                         )}
                        {/* Hiển thị icon lỗi nếu fetch profile thất bại */}
                         {!profileLoading && profileError && (
                              <FontAwesomeIcon icon={faExclamationTriangle} className="status-icon icon-warning" />
                         )}
                        ...
                        {!profileLoading && profileError && (
                            <p className="sub-message error-message">
                                ...
                                Không thể cập nhật số dư mới nhất. Vui lòng kiểm tra lại sau. ({profileError})
                            </p>
                        )}
                         {!profileLoading && !profileError && (
